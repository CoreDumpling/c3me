...
int dump_bic()
{
	...
	PRINT_STR(bic, BIC);
	PRINT_DWORD_BUF(bic, no_idea_1, "%p");
	PRINT_DWORD(bic, biqFilenamePtr, "%p");
	PRINT_DWORD_BUF(bic, no_idea_2, "%p");
	PRINT_STR(bic, pathNoExt);
	PRINT_STR(bic, pathWithExt);
	PRINT_STR(bic, c3cPath);
	PRINT_STR(bic, ptwPath);
	PRINT_DWORD_BUF(bic, no_idea_3, "%p");
	PRINT_STR(bic, saveTmp);
	PRINT_STR(bic, no_idea_4);
	PRINT_DWORD_BUF(bic, no_idea_5, "%p");
	...
	PRINT_DWORD(bic, no_idea_9, "%p");
	PRINT_DWORD(bic, buildingsPtr, "%p");
	PRINT_DWORD(bic, citizensPtr, "%p");
	PRINT_DWORD(bic, cityNamesPtr, "%p");
	PRINT_DWORD(bic, no_idea_10, "%p");
	PRINT_DWORD(bic, culturePtr, "%p");
	PRINT_DWORD(bic, difficultyPtr, "%p");
	PRINT_DWORD(bic, erasPtr, "%p");
	PRINT_DWORD(bic, espionagePtr, "%p");
	PRINT_DWORD(bic, experiencePtr, "%p");
	PRINT_DWORD_BUF(bic, no_idea_11, "%p");
	PRINT_DWORD(bic, no_idea_12_ptr, "%p");
	PRINT_DWORD(bic, no_idea_13_ptr, "%p");
	PRINT_DWORD_BUF(bic, no_idea_14, "%p");
	...
	PRINT_DWORD_BUF(bic, no_idea_16, "%p");
	PRINT_STR(bic, alliance1Name);
	PRINT_STR(bic, alliance2Name);
	PRINT_STR(bic, alliance3Name);
	PRINT_STR(bic, alliance4Name);
	PRINT_DWORD_BUF(bic, no_idea_17, "%p");
	PRINT_STR(bic, scenarioTitle2);
	PRINT_DWORD_BUF(bic, no_idea_18, "%p");
	PRINT_DWORD(bic, racesPtr, "%p");
	PRINT_DWORD(bic, resourcesPtr, "%p");
	PRINT_DWORD(bic, govtsPtr, "%p");
	PRINT_DWORD(bic, playersPtr, "%p");
	PRINT_DWORD(bic, unitsPtr, "%p");
	PRINT_DWORD(bic, menuArtPtr, "%p");
	PRINT_DWORD(bic, no_idea_19, "%p");
	PRINT_STR(bic, citySize1);
	PRINT_STR(bic, citySize2);
	PRINT_STR(bic, citySize3);
	PRINT_DWORD_BUF(bic, no_idea_20, "%p");
	PRINT_DWORD(bic, culturalLevelsPtr, "%p");
	...
	PRINT_DWORD_BUF(bic, no_idea_21, "%p");
	PRINT_DWORD(bic, techsPtr, "%p");
	PRINT_DWORD(bic, workerJobsPtr, "%p");
	PRINT_DWORD(bic, terrainPtr, "%p");
	PRINT_DWORD(bic, no_idea_22_ptr, "%p");
	PRINT_DWORD(bic, worldSizesPtr, "%p");
	PRINT_DWORD(bic, flavorsPtrPtr, "%p");
	PRINT_DWORD(bic, screenWidthPixels, "%d");
	PRINT_DWORD(bic, screenHeightPixels, "%d");
	PRINT_DWORD(bic, no_idea_24, "%p");
	return 0;
}
